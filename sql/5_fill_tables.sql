...
VALUES (3, NULL, '2022-02-06 15:52:57.567086', 'uuu@uuu.com', 2, '1', '294567651', 1, '1', 'Vatutina'),
       (5, NULL, '2022-02-06 15:52:57.567086', 'some@gmail.com', 2, '1', '999111222', 1, '1', 'Ватутина'),
       (9, NULL, '2022-02-06 15:52:57.567086', 'viviva5679@ymail365.com', 1, '1', '777444333', 1, '1', 'Беляева'),
       (21, NULL, '2022-02-06 15:52:57.567086', 'andreygordenevskiy@gmail.com', 5, '1', '294444455', 2,
        '1', 'Edwarda Wittiga'),
       (38, NULL, '2022-02-06 15:55:52.611265', 'asdasd@gmail.com', 2, '2', '294444455', 2, '4', 'Бородино'),
       (40, NULL, '2022-02-06 15:55:52.611265', 'semenov@gmail.com', 1, '1', '294444455', 1, '1', 'Семенова'),
       (42, NULL, '2022-02-06 15:55:52.611265', 'myemail@mail.ru', 1, '1', '294444455', 1, '1', 'Майова');

INSERT INTO user (id, creation, name, password, phone, role, surname, username, email, floor, house, porch, room,
                  street, is_blocked)
VALUES (12, '2022-02-06 15:55:52.611265', 'Anatoliy',
       ...
       (16, '2022-02-06 20:27:24.898557', 'Георгий', '29609ba0cfb2fc501a3f3ae31d0e4178334d06eacfd99a6cf389e3889867a09f',
        '444444444', 2, 'Станкевич', 'Avalon',
        'georgiy@uuu.com', 2, '2', 2, '2', 'Михайловский переулок', FALSE),
       (17, '2022-02-06 20:56:41.920967', 'Алина', '29609ba0cfb2fc501a3f3ae31d0e4178334d06eacfd99a6cf389e3889867a09f',
        '333333333', 2, 'Скубарева', 'Alinochka',
        'abcdefoo@gmail.com', 5, '5', 5, '5', 'Васьняцова', FALSE),
       (18, '2022-02-06 03:27:34.701067', 'Михаил', '29609ba0cfb2fc501a3f3ae31d0e4178334d06eacfd99a6cf389e3889867a09f',
        '333444555', 2, 'Семенов', 'nick',
        'my_new_email@gmail.com', NULL, NULL, NULL, NULL, NULL, FALSE),
       (20, '2022-02-06 04:08:03.960329', 'Афанасий',
...
VALUES (4, now(), 1, 0, 4, 3, NULL, 'Генадий'),
       (6, now(), 0, 0, 2, 5, NULL, 'Антон'),
       (10, now(), 0, 2020, 4, 9, NULL, 'Андрей'),
       (22, now(), 1, 17776, 2, 21, NULL, 'Виктор'),
       (39, now(), 0, 13610, 1, 38, NULL, 'Екатерина'),
       (41, now(), 0, 2008, 0, 40, NULL, 'Настя'),
       (43, now(), 0, 2020, 0, 42, 16, 'Торин');
