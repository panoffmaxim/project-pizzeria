...
public class UserUnBlock extends Command {
    private static final Logger LOGGER = LogManager.getLogger(UserUnBlock.class);
    ...
    public ResponseObject execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            LOGGER.error("Exception due invoking UserUnBlock ", e);
