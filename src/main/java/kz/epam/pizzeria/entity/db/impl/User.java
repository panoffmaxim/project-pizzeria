package kz.epam.pizzeria.entity.db.impl;
...
public class User extends Entity<Integer> implements Serializable {
    ...
    public User(Integer integer, String username, String password, Role role, String name, String surname, LocalDateTime creation,
                String street, String house, String room, Integer porch, Integer floor, String phone, String email, boolean blocked) {
        super(integer);
