...
//    private List<Product> products = new ArrayList<>();
    ...
    public Order(Integer integer, LocalDateTime creation, String clientName, Integer price, OrderStatus status, PaymentType paymentType,
                 DeliveryInf deliveryInf, User user, Map<Product, Integer> products) {
        super(integer);
